        ...
        children: [
          SingleChildScrollView(
            ...
            child: Stack(
              children: [
                CustomPaint(
                  size: Size(widget.width, widget.height), // タイムテーブルのサイズを調整
                  ...
                  InkWell(
                    child: CustomPaint(
                      ...
                      painter: RoundedRectPainter(
                        scheduleData: widget.schedules[i],
                        thisColor: widget.schedules[i]['category_data']
                            ['color'],
                        startTime: widget.schedules[i]['start_at'],
                        endTime: widget.schedules[i]['end_at'],
                        categoryName: widget.schedules[i]['category_data']
                            ['name'],
                      ),
                    ),
                    onTap: () {
